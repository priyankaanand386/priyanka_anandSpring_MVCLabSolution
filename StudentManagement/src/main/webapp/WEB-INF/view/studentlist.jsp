		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				<c:forEach items="${studentModel}" var="student">
					...
					<a href="/StudentManagement/students/delete?id=${student.id}" class="btn btn-danger btn-sm" onclick="if(!(confirm('Are you sure to delete this book?'))) return false">Delete</a>
					</td>
					</tr>
				</c:forEach>
				<!-- Tag lib For loop -->
